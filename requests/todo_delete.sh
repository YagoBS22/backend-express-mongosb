...
echo "Deletando tarefa com ID: $TODO_ID"
run_todo_test "Deletar Tarefa" -X DELETE "$BASE_URL_TODOS/$TODO_ID"

if [ -f "$TODO_ID_FILE" ]; then
  rm "$TODO_ID_FILE"
  echo "Arquivo '$TODO_ID_FILE' removido."
fi
